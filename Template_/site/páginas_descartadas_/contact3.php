...
<form name="enq" method="post" action="email/" onsubmit="return validation();">
  <fieldset>
	...
	<label><b>Escolha o dia para verificar as sessões dos Filmes</b></label> </br>
	<input type="text" name="palavra" title="Digite o nome do filme ou uma categoria"/></br></br> 
