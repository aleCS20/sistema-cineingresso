                ...
                <div class="span12">
                    ...
                    <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                            ...
                            <li><a href="contact2.php">Filmes</a></li>
                            ...
                            <li><a href="contact5.php">Comprar</a></li>
...
<form name="enq" method="post" action="email/" onsubmit="return validation();">
  <fieldset>
	...
	<strong>Preencha os campos abaixo para reservar ingressos: </strong></br></br>
	
	<strong>Escolha o Filme em cartaz: </strong></br>
	<select name="escolha_filme" title="Escolha o filme em cartaz">
	...
	<select name="escolha_horario" title="Escolha a hora da sessão do filme">
	...
	<strong>Quantidade - máximo de 4 ingressos</strong></br>
	<select name="escolha_Quantidade" title="Escolha a quantidade de ingressos">
	 <option value="1">1<br>
	 <option value="2">2<br>
	 <option value="3">3<br>
	 <option value="4">4<br>
	...
	<input type="submit" value="Reservar" title="Clique para Reservar e salvar"/> &nbsp&nbsp&nbsp
	<input type="reset" value="Cancelar" title="Clique para cancelar a reserva"></br>
