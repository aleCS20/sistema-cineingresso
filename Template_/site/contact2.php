 ...
 <form name="enq" method="post" action="busca_filme.php"> <!--onsubmit="return validation();"-->
  <fieldset>
	...
	<?php
	 ...
	 $res = mysql_query("SELECT filme.TitFilme, sala.Local, sessao.DataSessao, sessao.HorarioSessao FROM filme, sala, sessao WHERE filme.IdFilme = sessao.IdFilme AND sala.IdSala=sessao.IdSala");
	 ...
	 while($escrever=mysql_fetch_array($res)){
	  ...
	  echo "<tr align=center><td>".$escrever['TitFilme']."</td><td>".$escrever['Local']."</td><td>".$escrever['DataSessao']."</td><td>".$escrever['HorarioSessao']."</td></tr>";
	 }
