    ...
    <div class="divPanel page-content">
        ...
        <div class="row-fluid">
                <div class="span8" id="divMain">
					...
					<hr>
			<!--Start Contact form -->		                                                
  <form name="enq" method="post" action="cad_clientes.php"><!--action="email/" onsubmit="return validation();"-->
    <fieldset>
    
	<strong>Nome Completo: * </br><input type="text" name="NomeCliente" size="100" title="Digite seu nome completo"/><!-- class="input-block-level" placeholder="Name"--></strong></br>
    <strong>Endereço Completo: * </br><input type="text" name="EnderecoCompleto" size="90" title="Digite seu endereço completo"/><!--id="email" value="" class="input-block-level" placeholder="Email"--></strong></br>
	<strong>Telefone: * </br><input type="text" name="TelefoneCliente" size="40" title="Digite seu telefone"/></strong></br>
    <!--<textarea rows="11" name="message" id="message" class="input-block-level" placeholder="Comments"></textarea>-->
    <!--<strong>Sexo: *&nbsp&nbsp </br><input name="SexoCliente" type="radio" title="Escolha seu sexo" value="Masculino"> Masculino &nbsp&nbsp
	<input name="SexoCliente" type="radio" title="Escolha seu sexo" value="Feminino"> Feminino </strong></br>-->
	<strong>Sexo: * </br>
	<select name="SexoCliente" title="Escolha seu sexo">
	 <option>
	 <option value="Feminino">Feminino
	 <option value="Masculino">Masculino
	</select></br> 
	<strong>Senha: * </br><input name="SenhaCliente" type="password" title="Digite uma senha"></strong></br></br>
	
	<input type="submit" value="Cadastrar" name="submit" title="Clique para confirmar e salvar o cadastro"/><!--id="submitButton" class="btn btn-info pull-right"/-->
	&nbsp&nbsp <input type="reset" value="Cancelar" name="reset" title="Clique para cancelar seu cadastro"/></br></br> <!--id="submitButton" class="btn btn-info pull-right"/-->
