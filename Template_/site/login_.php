    ...
    <div class="divPanel page-content">
        ...
        <div class="row-fluid">
                <div class="span8" id="divMain">
					...
					<hr>
			<!--Start Contact form -->		                                                
  <form name="enq" method="post" action="logar.php"><!--action="email/" onsubmit="return validation();"-->
    <fieldset>
    
	<strong>Id do Cliente: * </br><input type="text" name="IdCliente" id="IdCliente" size="100" title="Digite seu id"/><!-- class="input-block-level" placeholder="Name"--></strong></br>
    <strong>Senha: * </br><input type="password" name="SenhaCliente" id="SenhaCliente" size="90" title="Digite sua senha"/><!--id="email" value="" class="input-block-level" placeholder="Email"--></strong></br>
	
	<input type="submit" value="Realizar Login" id="entrar" name="entrar" title="Clique para logar"/><!--id="submitButton" class="btn btn-info pull-right"/-->
	</br><a href="contact.php" title="Clique para ir para à página de cadastro">Cadastre-se</a> &nbsp&nbsp
	<a href="index.html" title="Clique para sair e voltar à página home">Sair</a></b>
